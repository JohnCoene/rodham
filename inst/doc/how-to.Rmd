...
You can clean the emails with `clean_emails` it'll remove some comments and other unwanted lines.
...
```{r get dates, echo=TRUE, eval=FALSE}
...
```{r get addresses, echo=TRUE, eval=FALSE}
